package com.example.springbatchpractice.batch.itemreader.expression;
...
/**
 * Created by jojoldu@gmail.com on 23/01/2020 Blog : http://jojoldu.tistory.com Github :
...
public enum WhereExpression {
    ...
    public <N extends Number & Comparable<?>> BooleanExpression expression(NumberPath<N> id,
        int page, N currentId) {
